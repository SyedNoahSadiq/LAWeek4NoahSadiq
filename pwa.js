...
const cacheName = 'LAWeek4NoahSadiq-2021-02-24 15:07:09.111755'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4NoahSadiq'.length) === 'LAWeek4NoahSadiq') {
